                    ...
                    <DropdownMenu>
                        ...
                        >
                            ...
                            {NAV_LINKS.map(({ href, label, icon: Icon }) => (
                                <DropdownMenuItem key={href} asChild className="cursor-pointer text-[#aaa] focus:text-white focus:bg-white/5">
                            ...
                            <DropdownMenuSeparator className="bg-white/10" />
                            <DropdownMenuItem className="cursor-pointer text-[#666] focus:text-red-400 focus:bg-white/5">
                        ...
                        {isSignedIn && (
                            <nav className="flex flex-col gap-1 px-2 py-4 flex-1">
                                ...
                                <div className="border-t border-white/10 mt-4 pt-4">
                                    <SheetClose asChild>
                                        <button className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-[#666] hover:text-red-400 hover:bg-white/5 transition-all w-full">
